...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sklep z telefonami komórkowymi w Jaśle. Sprzedaż smartfonów (iPhone, Samsung, Xiaomi), profesjonalny serwis i akcesoria. ul. Czackiego 21." },
      { name: "author", content: "MOBILZONE" },
